...
ysin = np.sin((2*math.pi*np.arange(len(sat_time)))/5715 + (0.7 + (day - 150926)*0.199)*math.pi)
...
plot4 = ax3.plot(daytime_sun, ysin, 'g-', label = 'Orbital period')
plot5 = ax3.plot(daytime_sun, ycon, 'b--', label = 'Constant background')
