...
def calc_ang_eff(ang, detector):
    """This function converts the angle of one detector to a certain source into an effective angle considering the angular dependence of the effective area and stores the data in an array of the form: ang_eff\n
    Input:\n
...
day = 150926
sun_or = calc_sun_ang(n0, day)
sun_ang = sun_or[0]
sat_time = sun_or[1]
sun_ang_eff = calc_ang_eff(sun_ang, n0)
...
plt.title('Sun-angle of the n0-detector on the 26th Sept 2015')
