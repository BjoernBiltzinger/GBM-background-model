...
saa_dict = {"time_after_saa": 5000, "short_time_intervals": False, "nr_decays": 1}
...
gaussian_dict = {
    ...
    "sun_bound": [(None, None), (2.0, 1.0)],
}

##################### Input for multinest sampler ###################################################

multi_dict = {"num_live_points": 400, "constant_efficiency_mode": True}
