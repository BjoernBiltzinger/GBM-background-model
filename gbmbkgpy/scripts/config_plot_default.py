...
style_config = {
    ...
    'model':        {'color': 'firebrick',                      'alpha': .8, 'linewidth': 0.6},
    'data':         {'color': 'k',                              'alpha': .5, 'linewidth': 0.1, 'marker_size': 1},
    'sources': {
        'cr':       {'color': [0.267004, 0.004874, 0.329415],   'alpha': .6, 'linewidth': 0.8},
        'earth':    {'color': [0.267968, 0.223549, 0.512008],   'alpha': .6, 'linewidth': 0.8},
        'cgb':      {'color': [0.190631, 0.407061, 0.556089],   'alpha': .6, 'linewidth': 0.8},
        'constant': {'color': [0.127568, 0.566949, 0.550556],   'alpha': .6, 'linewidth': 0.8},
        'saa':      {'color': [0.20803,  0.718701, 0.472873],   'alpha': .6, 'linewidth': 0.8},
        'crab':     {'color': [0.565498, 0.84243,  0.262877],   'alpha': .6, 'linewidth': 0.8},
        'sun':      {'color': [0.993248, 0.906157, 0.143936],   'alpha': .6, 'linewidth': 0.8},
        'default':  {'color': 'blue',                           'alpha': .6, 'linewidth': 0.8},
        'global':   {'cmap':  'viridis',                        'alpha': .6, 'linewidth': 0.8},
        'use_global': False,
    },
