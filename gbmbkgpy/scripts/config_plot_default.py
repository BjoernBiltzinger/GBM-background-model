...
style_config = {
    ...
    "model": {"color": "red", "alpha": 0.8, "linewidth": 0.6, "show_label": True},
    "data": {
        "color": "k",
        "alpha": 0.4,
        "linewidth": 0.08,
    ...
    "ppc": {"color": ["lightgreen", "green", "darkgreen"], "alpha": 0.6},
    "legend_kwargs": {"loc": "center left", "bbox_to_anchor": (-0.17, -0.5), "ncol": 3},
}
