...
from gbmbkgpy.modeling.source import TransientSource
from gbmbkgpy.modeling.functions import Transient
...
for e in echan_list:
    ...
    parameter_bounds['norm_transient-1_echan-{}'.format(e)] = {
        'bounds': bounds_dict['transient_bound'][0],
        'gaussian_parameter': gaussian_dict['transient_bound'][0]
    }
    parameter_bounds['t_start-1_echan-{}'.format(e)] = {
        'bounds': bounds_dict['transient_bound'][1],
        'gaussian_parameter': gaussian_dict['transient_bound'][1]
    }
    parameter_bounds['t_rise-1_echan-{}'.format(e)] = {
        'bounds': bounds_dict['transient_bound'][2],
        'gaussian_parameter': gaussian_dict['transient_bound'][2]
    }
    parameter_bounds['t_decay-1_echan-{}'.format(e)] = {
        'bounds': bounds_dict['transient_bound'][3],
        'gaussian_parameter': gaussian_dict['transient_bound'][3]
    }
