...
# Global exception handler to kill all ranks on a exception
# Source: https://github.com/chainer/chainermn/pull/250/files
...
def _global_except_hook(exctype, value, traceback):
    ...
    try:
        ...
        sys.stderr.write("\n")
        sys.stderr.write("******************************************\n")
        sys.stderr.write("GBM Background Model: \n")
...
def _add_hook_if_enabled():
    ...
    # hang infinitely.
    # To activate this handler, set GBMBKGPY_FORCE_ABORT_ON_EXCEPTION
