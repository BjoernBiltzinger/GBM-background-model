...
cd = ContinuousData(date, detector, data_type, rate_gen, use_SAA=False)
...
#build model
source_list = []
echan_list=[2] #has to be a list! One entry or several entries!

#create the sources which are seperatly for all echans
...
# Plot Residuals and fit results with rank=0 
bin_width = 1
if rank==0:
    for echan in echan_list:
