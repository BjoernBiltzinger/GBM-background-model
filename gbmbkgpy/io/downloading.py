...
def download_data_file(date, type, detector="all"):
    ...
    try:
        ...
        try:
            url = "https://heasarc.gsfc.nasa.gov/FTP/fermi/data/gbm/daily/{0}/{1}/{2}/current/glg_{3}_{4}_{5}_v01.{6}".format(
                year, month, day, type, detector, date, file_type
            )
            ...
            try:
                url = "https://heasarc.gsfc.nasa.gov/FTP/fermi/data/gbm/daily/{0}/{1}/{2}/current/glg_{3}_{4}_{5}_v02.{6}".format(
                    year, month, day, type, detector, date, file_type
                )
                ...
                try:
                    url = "https://heasarc.gsfc.nasa.gov/FTP/fermi/data/gbm/daily/{0}/{1}/{2}/current/glg_{3}_{4}_{5}_v03.{6}".format(
                        year, month, day, type, detector, date, file_type
                    )
                    ...
                    try:
                        url = "https://heasarc.gsfc.nasa.gov/FTP/fermi/data/gbm/daily/{0}/{1}/{2}/current/glg_{3}_{4}_{5}_v04.{6}".format(
                            year, month, day, type, detector, date, file_type
                        )
