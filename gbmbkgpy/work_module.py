...
class readfile(object):
    ...
    def fits_data(self, day, detector_name, echan, data_type='ctime', sources_number='None'):
        ...
        sources_ang_bin = sources_ang_bin.view(sources_ang_bin.dtype[0]).reshape(sources_ang_bin.shape + (-1,)).astype(
            np.float).T
...
class writefile(object):
    ...
    def mcilwain_fits(self, week, day):
        ...
        lat_data = readfile.lat_spacecraft(readfile(),
        ...
        if x[0] == 0:
            ...
            lat_data2 = readfile.lat_spacecraft(readfile(),
