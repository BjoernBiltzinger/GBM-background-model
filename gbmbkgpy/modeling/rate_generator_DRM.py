...
class Rate_Generator_DRM(object):
    ...
    ##################################################### For CRAB
    def _spectrum_crab(self, energy, C, index_crab):#index_1_crab, index_2_crab, index_3_crab):
        """
        define the function of a power law. Needed for PS spectrum
        :param energy:
        :param C:
        ...
        return C*energy**(-index_crab)
    def _spectrum_crab_old(self, energy, C, index_1_crab, index_2_crab, index_3_crab):
        return C * energy**(-(index_1_crab+index_2_crab*np.log(energy/index_3_crab)))
    ...
    def _differential_flux_crab(self, e):
        ...
        old=False
        if old:
            return self._spectrum_crab_old(e, C, self._index_1_crab, self._index_2_crab, self._index_3_crab)
        else:
            return self._spectrum_crab(e, C, self._index_crab)# self._index_1_crab, self._index_2_crab, self._index_3_crab)
